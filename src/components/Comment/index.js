...
import { Button, Text, Thumbnail, Container, Badge, Input } from "native-base";
            ...
            <Col style={{ paddingLeft: 10, flex: 1, minHeight: 50 }}>
              ...
              <Row>
                <Text style={{ fontSize: 13 }}>
                  Vừa được xe ôm chở tới nơi, chưa kịp bước xuống đã có hàng chục người ...
                </Text>
              </Row>
            </Col>
          </Row>
          {index == 3 && loginReducer.user != null ? <Row style={{
            justifyContent: 'center',
            alignItems: 'center',
            width: '100%',
            borderBottomWidth: 0.5,
