...
class ProgressController extends Component {
    ...
    render() {
        let { moving, muted } = this.state;
        let { currentTime, duration, percent, changeMuted } = this.props;
        return <View style={styles.view}>
            ...
            <TouchableOpacity
                ...
                {muted ? <IconFontAwesome name="volume-off" style={{ color: '#fff' }} size={20} /> :
                    <IconFontAwesome name="volume-up" style={{ color: '#fff' }} size={20} />}
            </TouchableOpacity>
